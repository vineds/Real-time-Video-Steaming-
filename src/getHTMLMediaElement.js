...
function getHTMLMediaElement(mediaElement, config) {
    ...
    var buttons = config.buttons || ['mute-audio', 'mute-video', 'full-screen', 'stop'];
    ...
    if (config.title) {
        ...
        h2.setAttribute('style', 'position: absolute;color:white;font-size:17px;text-shadow: 1px 1px black;padding:0;margin:0;text-align: left; margin-top: 7vw; margin-left: 33vw; display: block; border: 0;line-height:1.5;z-index:1;');
